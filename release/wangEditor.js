...
Field.prototype = {
    ...
    onClick: function onClick() {
        var editor = this.editor;
        editor.cmd.do('insertElem', '<span data-contract-field="index" data-field-category="index" contenteditable="false" class="popover-tip">插入合同字段</span>');
    }
};
